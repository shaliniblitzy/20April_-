...
# Checkpoint 2 review finding MINOR/api-init). The relative form is the
# canonical Flask-tutorial idiom for blueprint package initializers
...
# side effects. The absolute form ``from app.blueprints.api import
